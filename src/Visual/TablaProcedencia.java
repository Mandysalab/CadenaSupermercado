...
public class TablaProcedencia extends javax.swing.JDialog {
    private final String[] colsNames = {"Producto","Precio","Procedencia"} ;
    DefaultTableModel controller = new DefaultTableModel();
    /**
     * Creates new form TablaProcedencia
     */
    public TablaProcedencia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        {
        initComponents();
        this.setTitle("Productos Importados/Procedencia");
        this.setResizable(false);
        controller.setColumnIdentifiers(colsNames);
